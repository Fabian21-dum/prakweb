      ...
      <?php
        ...
        <div class="col rounded">
          ...
          <img class="bd-placeholder-img object-fit-cover rounded-top" width="100%" height="200" src="images/<?php echo $article['images'];?>"></img>
            <div class="card-body">
            <h6 class="mb-2"><a href="mainkatw.php?action=kat&id_kat=<?php echo $article['id_kategori']?>" class="text-black text-decoration-none"><?php echo $article['id_kategori'];?></a></h6>

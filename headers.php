...
<div class="container">
  <header class="border-bottom lh-1 py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <!-- <h6><a class=" text-body-emphasis text-decoration-none" href="./mainview.php">View as a Viewer</a></h6> -->
  ...
  <div class="nav-scroller py-1 mb-3 border-bottom ">
    <nav class="nav nav-underline justify-content-between">
      ...
      <a class="nav-item nav-link link-body-emphasis" href="./inputpen.php">Input Penulis</a>
      <a class="nav-item nav-link link-body-emphasis" href="kategori.php">Lihat Kategori</a>
      <a class="nav-item nav-link link-body-emphasis" href="inputkat.php">Input Kategori</a>
      <a class="nav-item nav-link link-body-emphasis" href="index.php">Lihat Berita</a>
